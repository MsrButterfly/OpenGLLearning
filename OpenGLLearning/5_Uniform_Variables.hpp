#ifndef _5_UNIFORM_VARIABLES_HPP_INCLUDED
#define _5_UNIFORM_VARIABLES_HPP_INCLUDED
...
namespace _5_Uniform_Variables {

    const char *title = "Uniform Variables";
...
void main() {
    ...
    static int main(int argc, const char *argv[]) {
        ...
        auto scaleLocation = glGetUniformLocation(program, "Scale");
        GLfloat scale = 0.0f;
        using namespace glm;
        vec3 vertices[3] = {
            {-1.0f, -1.0f, 0.0f},
