#ifndef _8_SCALING_TRANSFORMATION_HPP_INCLUDED
#define _8_SCALING_TRANSFORMATION_HPP_INCLUDED
...
namespace _8_Scaling_Transformation {

    const char *title = "Scaling Transformation";
